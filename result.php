...
<body class="bg-[#FFF7EB]">
    ...
    if (isset($_POST["submit"])) {
        ...
        $querya = "INSERT INTO reasult ( name,roll,class,father,mother,address,maths,english,hindi,science,gread ,birth) VALUES ('$name', '$roll', '$class', '$father', '$mother', '$address', '$maths', '$eng', '$hindi', '$science' ,'$grade','$birth')";
    ...
    <div class="flex justify-center  items-center  mt-[-150px] ">
        <form action="result.php" method="post"
            ...
            <h4 class=" font-bold text-l  p-2 flex gap-1"><svg class="text-blue-500" xmlns="http://www.w3.org/2000/svg"
                    width="16" height="16" fill="currentColor" class="bi bi-file-earmark-fill" viewBox="0 0 16 16">
                    <path
            ...
            <div class="flex flex-col-2 gap-3 mb-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="number" name="roll" class="border  border-black rounded border-[1px]"
            ...
            <input type="text" name="english" class="border  border-black rounded border-[1px]"
                placeholder="Enter Name">
            <label for="">Hindi</label>
            <input type="text" name="hindi" class="border  border-black rounded border-[1px]" placeholder="Enter Name">
            <label for="">Science</label>
            <input type="text" name="science" class="border  border-black rounded border-[1px]"
                placeholder="Enter Name">
            <input type="submit" name="submit"
                class="bg-blue-500 w-[150px] text-white py-2 px-4 rounded  self-center mt-4" value="Save">
        </form>
    </div>
